# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 00:39:43 2024

@author: joonc
"""
#correcting some data points(last year)
import pandas as pd
import os
...
output_dir = 'C:/Users/joonc/Documents'  # Change this to a directory where you have write permissions

# Define age groups and file patterns
age_groups = ['0-9', '10-19', '20-29', '30-39', '40-49', '50-59', '60-69', '70-79', '80 이상', '남성', '여성']
file_patterns = [
...
def process_and_merge_files_for_age_group(age_group):
    ...
    if df_list:
        ...
        # Fix cumulative columns
        merged_df['deaths'] = merged_df['deaths'].replace(0, method='ffill')
        ...
        output_file = os.path.join(output_dir, f'covid19_data_20200120_to_20230731_{age_group}_processed.csv')
...
all_data = []
for age_group in age_groups:
    processed_file_path = os.path.join(output_dir, f'covid19_data_20200120_to_20230731_{age_group}_processed.csv')
...
if all_data:
    ...
    final_output_file = os.path.join(output_dir, 'covid19_data_20200120_to_20230731_all_ages_processed.csv')
